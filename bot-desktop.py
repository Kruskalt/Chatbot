...
def get_formalities_response(formality) : #se fija si esta in greet  y lo hace para cada greet 
...
def remove_punctuation_marks(text) :  #eliminar caracteres
    punctuation_marks = dict((ord(punctuation_mark), None) for punctuation_mark in string.punctuation) #crea un dicc
